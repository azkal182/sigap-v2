...
interface LeadershipFormDialogProps {
  open: boolean
  onClose: () => void
  onSubmit: (params: AddLeadershipMemberInput) => void
  defaultValues?: Partial<AddLeadershipMemberInput>
}

const AddLeadershipMemberSchemaDialog: React.FC<LeadershipFormDialogProps> = ({
  open,
  onClose,
  onSubmit,
  defaultValues
  ...
  } = useForm<AddLeadershipMemberInput>({
    // @ts-ignore
    resolver: zodResolver(addLeadershipMemberSchema),
    mode: 'onChange',
    defaultValues: {
      studentId: '',
      notes: '',
      role: PositionRole.MEMBER, // tetap isi role
...
export default AddLeadershipMemberSchemaDialog

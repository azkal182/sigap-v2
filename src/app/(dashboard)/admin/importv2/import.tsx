...
//           throw new Error(
//             `Validasi schema gagal: ${firstErrorPath ? `Kolom '${firstErrorPath}'` : 'Data'} ${dataArrayIndex}: ${firstErrorMessage || 'Data tidak sesuai format.'}`
//           )
//         }
...
//     try {
//       // `validateImportDataOnServer` harus bisa menerima array `ExcelRowData` yang berisi `dormitoryId` dan `dormitoryName`
...
//           } else {
//             console.warn(
//               `Melewatkan baris (NIS: ${dataRow.NIS}) karena data yang dibutuhkan tidak lengkap/valid setelah validasi server. Pesan: ${dataRow.__validationMessage || 'Unknown issue.'}`
//             )
